...
from constants import RANDOM_SEED, BERT_PRETRAINED_MODEL, NUM_CPU, \
    DIALOGUE_ANNOTATOR_PRETRAIN_DATA_DIR, DIALOGUE_ANNOTATOR_PRETRAIN_MLM_DIR
...
logger = init_logger("MLM-pretraining", f"{DIALOGUE_ANNOTATOR_PRETRAIN_MLM_DIR}")
...
def main():
    ...
    args.output_dir = Path(DIALOGUE_ANNOTATOR_PRETRAIN_MLM_DIR) / args.masking_method / "model"
    args.fp16 = FP16
    mlm_pretrain(args)
